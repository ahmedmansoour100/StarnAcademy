        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-48 items-center">
            ...
            <div className="text-center lg:col-span-2 lg:order-last">
              ...
              <h1 className="text-6xl md:text-8xl font-bold text-white mb-8 leading-tight" data-testid="text-hero-title">
                نحن لا نعلم البرمجة فقط، بل نبني مبتكري الغد
              </h1>
              <p className="text-2xl md:text-3xl text-white/90 mb-12 ltr leading-relaxed" data-testid="text-hero-subtitle">
            ...
            {/* Right side - Image */}
            <div className="flex justify-center lg:col-span-4 lg:order-first">
              <img 
                src="/classroom-1.png" 
                alt="فصل تعليمي 1" 
